...
const commands = [
  ...
  new SlashCommandBuilder()
    ...
    .addIntegerOption(opt =>
      opt.setName("living")
        .setDescription(`<:Butterfly:1516679919399338074>The Living: hồi Sanity = count÷4 mỗi hit (tối đa ${BUTTERFLY_LIVING_MAX})`)
        .setMinValue(0).setMaxValue(BUTTERFLY_LIVING_MAX).setRequired(false))
    .addIntegerOption(opt =>
      opt.setName("departed")
        .setDescription(`<:Butterfly:1516679919399338074>The Departed: bonus dmg = Sinking÷2+count/ mỗi hit, cap 15/30 (tối đa ${BUTTERFLY_DEPARTED_MAX})`)
